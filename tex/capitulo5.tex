...
\hline
\hline
\multicolumn{1}{||l|}{\textbf{\texttt{SessionBean}}}				& \multicolumn{1}{l||}{Página de \textit{login}} \\ 
\hline
\multicolumn{1}{||l|}{\textbf{\texttt{SignUpBean}}}				& \multicolumn{1}{l||}{Página de cadastro de novos usuários} \\
\hline
\multicolumn{1}{||l|}{\textbf{\texttt{FileUploadBean}}}			& \multicolumn{1}{l||}{Página relativa à \textit{upload} de arquivos} \\  
\hline
\multicolumn{1}{||l|}{\textbf{\texttt{DeleteFileBean}}} 			& \multicolumn{1}{l||}{Página de deleção de arquivos do usuário} \\ 
\hline
\multicolumn{1}{||l|}{\textbf{\texttt{WorkflowComposerBean}}} 	& \multicolumn{1}{l||}{Página de composição, \textit{design} e submissão de \textit{workflows}}      \\ 
\hline
\multicolumn{1}{||l|}{\textbf{\texttt{WorkflowStatusBean}}}		& \multicolumn{1}{l||}{Página para visualização do \textit{status} dos \textit{workflows} gerenciados pelo usuário}        \\ 
\hline
\multicolumn{1}{||l|}{\textbf{\texttt{WorkflowHistoryBean}}}		& \multicolumn{1}{l||}{Contém o histórico de execução de um determinado \textit{workflow}}        \\
\hline
\end{tabular}
}
